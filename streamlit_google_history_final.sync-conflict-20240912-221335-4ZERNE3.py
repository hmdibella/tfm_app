...
def main():
    ...
    avatar_assistant = st.image('https://github.com/hmdibella/tfm_app/blob/main/perfil_bot.jpg?raw=true', width=30)
    avatar_user = st.image('https://github.com/hmdibella/tfm_app/blob/main/perfil_humano.jpg?raw=true', width=30)
