...
def main():
    ...
    if "context" not in st.session_state:
        ...
        with st.chat_message("Semaforín"):
            response = st.write_stream(response_generator_bot("Hola! 👋 Soy Semaforín 🤖, tu colega-bot que responde preguntas ❓ sobre las leyes de Tráfico y Seguridad Vial 🚗 en España. Hazme las preguntas y yo trataré de responderlas 💪."))
